...
class PhotoControllerService extends __BaseService {
  static readonly savePhotoUsingPOSTPath = '/gestiondesstock/v1/photo/{id}/{title}/{context}';
  ...
  savePhotoUsingPOSTResponse(params: PhotoControllerService.SavePhotoUsingPOSTParams): __Observable<__StrictHttpResponse<{}>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondesstock/v1/photo/${encodeURIComponent(String(params.id))}/${encodeURIComponent(String(params.title))}/${encodeURIComponent(String(params.context))}`,
      __body,
      {
        headers: __headers,
        params: __params,
